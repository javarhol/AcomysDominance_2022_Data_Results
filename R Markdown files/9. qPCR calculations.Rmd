...
```{r import_data}
raw_data <- read_excel("/Volumes/GoogleDrive-105793286447324059497/My Drive/UF/Data_AcomysDominance/Data for Publication/qPCR_data_dominance1.xlsx", sheet="DuplicatedRuns_Removed")
```
...
primer_effis <- read_xlsx("/Volumes/GoogleDrive-105793286447324059497/My Drive/UF/Data_AcomysDominance/Data for Publication/qPCR_primer_effis_converted.xlsx")
...
inv_data <- read_excel("/Volumes/GoogleDrive-105793286447324059497/My Drive/UF/Data_AcomysDominance/Data for Publication/AcomysDomRegen_Inventory.xlsx")
```
...
```{r}
write.csv(tidy_data_pfaffl2, "/Volumes/GoogleDrive-105793286447324059497/My Drive/UF/Data_AcomysDominance/Data for Publication/qpcr_combined_082922.csv")
```