...
```
```{r}
m.agestab <- lmer(AgeAtTest ~ (1|Cage) + stab_status, data=rank_stab)
m.agestab.simp <- lm(AgeAtTest ~ stab_status, data=rank_stab)

anova(m.agestab)
summary(m.agestab)

r.squaredGLMM(m.agestab.simp)
...
ggsave("/Users/justinvarholick/Documents/GitHub/AcomysDominance_2022_Data_Results/R generated figures/Fig2_stab_plots.tiff", figx, units="cm", width = 30, height = 15, device='tiff', dpi=300)
