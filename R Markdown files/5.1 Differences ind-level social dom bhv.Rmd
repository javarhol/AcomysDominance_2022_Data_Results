...
```{r import data}
adata <- read.csv("/Volumes/GoogleDrive-105793286447324059497/My Drive/UF/Data_AcomysDominance/Data for Publication/dominanceevents_MASTER_adj.csv", stringsAsFactors=TRUE)
...
dom_sex_plot <- ggplot(sex_dyads_dom, aes(Behavior, n, color=Sex, fill=Sex))+
  geom_dotplot(binaxis='y', stackdir='center', position=position_dodge(0.5), binwidth = 8)+
...
ggsave("/Users/justinvarholick/Documents/GitHub/AcomysDominance_2022_Data_Results/R generated figures/Fig3_socbhv_plots.tiff", fig3, units="in", width = 6.5, height = 4, device='tiff', dpi=300)
