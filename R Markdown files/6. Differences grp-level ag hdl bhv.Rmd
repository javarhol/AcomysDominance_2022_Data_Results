...
```{r data import}
#import data
data_master <- read.csv("/Volumes/GoogleDrive-105793286447324059497/My Drive/UF/Data_AcomysDominance/Data for Publication/Ag_Boris_20211109_fromMaster_B1B2B3.csv")
