...
#mixed model
```{r}
m.earclose.full <- lmer(DaysToClose ~ (1|Cage.x) + ds + stab_status + ds*stab_status, data=eardata, REML=F, control=lmerControl(optimizer="bobyqa"))
m.earclose.simp <- lm(DaysToClose ~ ds + stab_status + ds*stab_status, data=eardata)

m.earclose.age <- lmer(DaysToClose ~ (1|Cage.x) + AgeAtTest + ds + stab_status + ds*stab_status, data=eardata, REML=F, control=lmerControl(optimizer="bobyqa"))
